...
PRO_NAME="seckill-common-1.0-SNAPSHOT"
JAR_NAME="${PRO_NAME}.jar"
WORK_PATH="/work/${PRO_NAME}"
MAIN_CLASS="com.smallbell.springcloud.seckill.start.SeckillCloudApplication"
JVM="-server -Xms64m -Xmx256m"
export log_seckill_provider_path=/work/logs/${PRO_NAME}
