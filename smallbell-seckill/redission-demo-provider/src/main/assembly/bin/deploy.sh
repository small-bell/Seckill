...
PRO_NAME="redission-demo-provider-1.0-SNAPSHOT"
JAR_NAME="${PRO_NAME}.jar"
WORK_PATH="/work/${PRO_NAME}"
MAIN_CLASS="com.smallbell.springcloud.seckill.start.RedissionDemoCloudApplication"
JVM="-server -Xms64m -Xmx256m"
export log_redission_demo_provider_path=/work/logs/${PRO_NAME}
