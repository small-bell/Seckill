package com.smallbell.springcloud.demo.constants;
...
public class TestConstants
{
    ...
    public static final String DEMO_CLIENT_PATH =
            "http://skbelldemo.com:7700/demo-provider/";
    ...
    public static final String HELLO_TEST_URL =
            "http://skbelldemo.com:7700/demo-provider/api/demo/hello/v1";
    ...
    public static final String USER_INFO_URL =
            "http://skbelldemo.com:7700/uaa-provider/api/user/detail/v1?userId=1";
