package com.smallbell.springcloud.message.handlers;

import com.smallbell.springcloud.message.annotation.MqSubscriber;
import com.smallbell.springcloud.message.annotation.TopicConsumer;
