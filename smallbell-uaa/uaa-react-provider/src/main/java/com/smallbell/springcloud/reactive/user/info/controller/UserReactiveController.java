package com.smallbell.springcloud.reactive.user.info.controller;

import com.smallbell.springcloud.common.result.RestOut;
import com.smallbell.springcloud.reactive.user.info.dto.User;
import com.smallbell.springcloud.reactive.user.info.service.impl.JpaEntityServiceImpl;
...
//    @ApiImplicitParam(paramType = "body", dataType="com.smallbell.springcloud.reactive.user.info.dto.User",  required = true)
