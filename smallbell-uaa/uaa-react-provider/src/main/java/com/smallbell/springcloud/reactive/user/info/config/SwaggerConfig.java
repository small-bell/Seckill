package com.smallbell.springcloud.reactive.user.info.config;
...
//        return new Docket(DocumentationType.OAS_30)
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.smallbell.springcloud.reactive.user.info.controller"))
    ...
    private ApiInfo apiInfo()
    {
        return new ApiInfoBuilder()
                ...
                //条款地址
                .termsOfServiceUrl("https://www.cnblogs.com/smallbellcircle/")
                .contact(new Contact("疯狂创客圈", "https://www.cnblogs.com/smallbellcircle/", ""))
                .version("1.0")
                .build();
    }
