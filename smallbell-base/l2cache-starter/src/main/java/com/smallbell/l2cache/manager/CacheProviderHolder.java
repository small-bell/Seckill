 ...
 */
package com.smallbell.l2cache.manager;


import com.smallbell.l2cache.caffeine.CaffeineProvider;
import com.smallbell.l2cache.config.J2CacheCoreConfig;
import com.smallbell.l2cache.redis.RedisCacheProvider;
...
public class CacheProviderHolder {
     ...
     */
    public static CacheProviderHolder init(J2CacheCoreConfig config, CacheExpiredListener listener) {
