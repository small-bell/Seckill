package com.smallbell.springcloud.kafka.mq.producer.internal.kafka;
...
public class KafkaProducerServer extends AbstractKafkaMqProducer {
    ...
    public String send(ProduceMessage message) {
        ProducerRecord<String, byte[]> producerRecord = new ProducerRecord<>(message.getTopic(),
                null, null,
                null, message.getPayload(),
                getUserProperties(message));
        try {
