package com.smallbell.springcloud.kafka.controller;

import com.smallbell.springcloud.common.result.RestOut;
import com.smallbell.springcloud.common.util.JsonUtil;
import com.smallbell.springcloud.kafka.controller.dto.NewTopicDto;
import com.smallbell.springcloud.kafka.controller.dto.SampleMsgDTO;
import com.smallbell.springcloud.kafka.mq.admin.KafkaAdmin;
import com.smallbell.springcloud.kafka.mq.producer.ProduceMessage;
...
@RestController
@RequestMapping("/api/smallbell/kafka/")
@Api(tags = "消息管理")
